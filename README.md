...
<b>2. Click on "Add File", copy and paste the contents of your rclone.conf (should only have one remote) and <a href='https://github.com/notabhixhek/nzbr/blob/master/temp.tegbzn.conf'>tegbzn.conf</a> </b><br><br>
